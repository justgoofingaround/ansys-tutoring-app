...
# LLM features off by default in the cloud (no Ollama); every LLM path
# degrades gracefully. Instructor account comes from INSTRUCTOR_USERNAME /
# INSTRUCTOR_PASSWORD env vars at deploy time.
ENV ENABLE_LLM=0 \
