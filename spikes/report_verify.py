"""Report validation for the Tut-1 spike.

The student uploads a generated report after finishing the tutorial. This
module performs the standard checks described in mock_server/data/tut1.json
and returns structured feedback the UI can display.
"""
...
def validate_report(report_path, tutorial_data):
